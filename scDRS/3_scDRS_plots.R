...
meta_all <- readRDS("D1-2-3-24h_qc_pca_umap_clust_harmony.rds")
#read scDRS results 
filenames_Scores <- Sys.glob("scDRS_result/*.score")
...
ggsave("barplot-asthma_per.tiff", dpi = 500, width = 14, height = 10)
...
ggsave("barplot-all_cells_asthma_per.tiff", dpi = 500, width = 11, height = 10)
...
ggsave("barplot-all_cells_asthma_per.tiff", dpi = 500, width = 15, height = 8)
